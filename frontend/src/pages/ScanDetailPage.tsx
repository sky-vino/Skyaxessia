...
const TABS = [
  ...
  // Hidden from tab bar per Round 2a. To re-enable, uncomment the line below.
  // The LiveDomTab component and its case in the render switch are kept intact.
  // { id: "livedom",   label: "Live DOM",    icon: Eye },
  //
  // Note: A "Screen Reader" tab was visible in a running build but is not
  // present in this project snapshot. If it exists in your working tree,
  // remove it from its TABS array the same way — comment out the { id: "screenreader", ... } entry.
];
